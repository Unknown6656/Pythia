...
public static class Program
{
    ...
    public const string DOTNET_VERSION = "9.0.300-preview.0.25177.5";
    ...
    public const string REPOSITORY_NAME = "Pythia";
    ...
    public const int START_YEAR = 2025;
    ...
    public static void Main(string[] args)
    {
        ...
        {
            /// <summary>
            /// The project's author. This value is equal to the author of the GitHub repository associated with <see cref="RepositoryURL"/>.
            /// </summary>
            ...
            /// <summary>
            /// The project's copyright information.
            /// </summary>
            public const string Copyright = "{{copyright}}";
            /// <summary>
            /// The project's current version.
            /// </summary>
            public static Version? ProgramVersion { get; } = Version.Parse("{{version_next}}");
            /// <summary>
